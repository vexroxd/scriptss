...
do
    ...
    Tabs.Main:AddButton({
        Title = " Restaurant Tycoon 2 Script  ",
        Description = "Very important button",
        Callback = function()
            Window:Dialog({
                Title = "Title",
    ...
    Tabs.Main:AddButton({
        Title = "  Toilet Tower Defense Script ",
        Description = "Very important button",
        Callback = function()
            Window:Dialog({
                Title = "Title",
    ...
    Tabs.Main:AddButton({
        Title = "  THE CLASSIC Script – Finish Quest / Tokens ",
        Description = "Very important button",
        Callback = function()
            Window:Dialog({
                Title = "Title",
    ...
    Tabs.Main:AddButton({
        Title = "Bee Swarm Simulator Script – Find All Tix ",
        Description = "Very important button",
        Callback = function()
            Window:Dialog({
                Title = "Title",
    ...
    Tabs.Main:AddButton({
        Title = " Arsenal Script – Find All Tokens/Tix   ",
        Description = "Very important button",
        Callback = function()
            Window:Dialog({
                Title = "Title",
    ...
    Tabs.Main:AddButton({
        Title = " Driving Empire Script – Find All Tix | Tokens Farm   ",
        Description = "Very important button",
        Callback = function()
            Window:Dialog({
                Title = "Title",
    ...
    Tabs.Main:AddButton({
        Title = " Clip It Script – Instant Get Tokens/Tix  ",
        Description = "Very important button",
        Callback = function()
            Window:Dialog({
                Title = "Title",
    ...
    Tabs.Main:AddButton({
        Title = " Tower Defense Simulator Script – Find All Tix  ",
        Description = "Very important button",
        Callback = function()
            Window:Dialog({
                Title = "Title",
    ...
    Tabs.Main:AddButton({
        Title = "   Dragon Adventures Script ",
        Description = "Very important button",
        Callback = function()
            Window:Dialog({
                Title = "Title",
